...
<table style="margin: 0px auto;">
  ...
  <tr> 
    ...
    <td><input id="end_timetime" type="time"></td> 
  </tr>
</table>
...
<table style="margin: 0px auto;" >
	<tbody>
		...
		<tr>
			<td><input type="radio" name="computer"> Computers </td>
			<td><input type="radio" name="RN"> Rober North </td>
			<td> <input type="radio" name="under_20"> Under 20 </td>
		</tr>
		<tr>
			<td><input type="radio" name="blackboard" > Blackboard </td>
			<td><input type="radio" name="RS" > Robert South </td>
			<td><input type="radio" name="20-40"> 20-40</td>
		</tr>
		<tr>
			<td> </td>
			<td><input type="radio" name="BC" > Bauer Center </td>
			<td> <input type="radio" name="41-60"> 41-60 </td>
		</tr>
		<tr>
			<td> </td>
			<td> <input type="radio" name="KS" > Kravis Center </td>
			<td><input type="radio" name="above_60"> Above 60 </td>
		</tr>
		<tr>
			<td> </td>
			<td> </td>
